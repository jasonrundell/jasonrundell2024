...
export const SITE_DESCRIPTION =
  'Jason Rundell is an engineering leader with 15+ years in full-stack web development - joining at inflection points to build the systems, culture, and standards that let teams scale.'
