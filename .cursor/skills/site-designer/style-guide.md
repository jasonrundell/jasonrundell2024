...
Contrast: WCAG 2.1 AA (4.5:1 text, 3:1 large text). `inkMuted`, `inkFaint`,
and `lineSubtle` are intentionally darker than the original Pencil swatches so
muted body/meta text clears AA on the paper ground.
